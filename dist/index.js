...
/* Generated by Opal 0.11.4 */
(function(Opal) {
  var TMP_1, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $send = Opal.send, $truthy = Opal.truthy, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$ready?', '$on', '$find', '$get', '$ok?', '$text', '$body', '$inspect', '$Native', '$version', '$puts', '$authorize', '$post', '$new', '$new_card']);
  
  self.$require("opal");
  self.$require("native");
  self.$require("opal/jquery");
  return $send(Opal.const_get_relative($nesting, 'Document'), 'ready?', [], (TMP_1 = function(){var self = TMP_1.$$s || this, TMP_2, trello = nil;

  
    $send(Opal.const_get_relative($nesting, 'Element').$find("#ajax"), 'on', ["click"], (TMP_2 = function(event){var self = TMP_2.$$s || this, TMP_3, div_demo = nil;
if (event == null) event = nil;
    
      div_demo = Opal.const_get_relative($nesting, 'Element').$find("#demo");
      return $send(Opal.const_get_relative($nesting, 'HTTP'), 'get', ["ajax_info.txt"], (TMP_3 = function(response){var self = TMP_3.$$s || this;
if (response == null) response = nil;
      if ($truthy(response['$ok?']())) {
          return div_demo.$text(response.$body())
          } else {
          return div_demo.$text(response.$inspect())
        }}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3));}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2));
    (function($base, $super, $parent_nesting) {
      function $Trello(){};
      var self = $Trello = $klass($base, $super, 'Trello', $Trello);

      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Trello_initialize_4, TMP_Trello_version_5, TMP_Trello_authentication_success_6, TMP_Trello_authentication_failure_7, TMP_Trello_authorize_8, TMP_Trello_creation_success_9, TMP_Trello_new_card_10;

      def.trello = nil;
      
      
      Opal.defn(self, '$initialize', TMP_Trello_initialize_4 = function $$initialize() {
        var self = this;

        return (self.trello = self.$Native(Trello))
      }, TMP_Trello_initialize_4.$$arity = 0);
      
      Opal.defn(self, '$version', TMP_Trello_version_5 = function $$version() {
        var self = this;

        return self.trello.$version()
      }, TMP_Trello_version_5.$$arity = 0);
      
      Opal.defn(self, '$authentication_success', TMP_Trello_authentication_success_6 = function $$authentication_success() {
        var self = this;

        return self.$puts("Successful authentication")
      }, TMP_Trello_authentication_success_6.$$arity = 0);
      
      Opal.defn(self, '$authentication_failure', TMP_Trello_authentication_failure_7 = function $$authentication_failure() {
        var self = this;

        return self.$puts("Failed authentication")
      }, TMP_Trello_authentication_failure_7.$$arity = 0);
      
      Opal.defn(self, '$authorize', TMP_Trello_authorize_8 = function $$authorize() {
        var self = this;

        return self.trello.$authorize($hash2(["type", "name", "scope", "expiration", "success", "error"], {"type": "popup", "name": "Getting Started Application", "scope": $hash2(["read", "write"], {"read": "true", "write": "true"}), "expiration": "never", "success": function(){ self.$authentication_success() }, "error": function(){ self.$authentication_failure() }}))
      }, TMP_Trello_authorize_8.$$arity = 0);
      
      Opal.defn(self, '$creation_success', TMP_Trello_creation_success_9 = function $$creation_success(data) {
        var self = this;

        
        self.$puts("Card created successfully.");
        self.$puts("" + "data " + (data));
        return self.$puts(JSON.stringify(data, null, 2));
      }, TMP_Trello_creation_success_9.$$arity = 1);
      return (Opal.defn(self, '$new_card', TMP_Trello_new_card_10 = function $$new_card() {
        var self = this, list = nil, card = nil;

        
        list = "5be618c7f0ee00436df7217a";
        card = $hash2(["name", "desc", "idList", "pos"], {"name": "Opal Ruby", "desc": "This is the description of our new card.", "idList": list, "pos": "top"});
        return self.trello.$post("/cards/", card, function(data){ self.$creation_success(data) });
      }, TMP_Trello_new_card_10.$$arity = 0), nil) && 'new_card';
    })($nesting[0], null, $nesting);
    trello = Opal.const_get_relative($nesting, 'Trello').$new();
    self.$puts("" + "Trello Version " + (trello.$version()));
    trello.$authorize();
    return trello.$new_card();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1));
})(Opal);
